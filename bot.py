...
OPTIONS = {
    1: "• Оформление бровей (Коррекция+окрашивание) 1300 вместо 1̶6̶0̶0̶₽",
    2: "• Долговременная укладка бровей (+коррекция, окрашивание и уход) 1500 вместо 1̶8̶0̶0̶₽",
    3: "• Ламинирование верхних ресниц (+окрашивание и уход) 1700 вместо 2̶0̶0̶0̶₽",
    4: "• Ламинирование верхних нижних ресниц (+окрашивание и уход) 2700 вместо 3̶0̶0̶0̶₽",
}
...
START_TEXT = (
    ...
    "🎁 Вот какие подарки можно выиграть:\n"
    ...
    "• Подарочек ✨\n\n"
    "Нажми кнопку ниже — я брошу кубик 🎲\n"
    "и покажу твой выигрыш 👇"
)
